...
const DataEmpty = ({
  ...
  return (
    <div className="mt-4 rounded-lg border border-dashed border-cultured bg-gradient-card py-4 text-sm text-white flex items-center justify-center">
      ...
      <div className={`w-6 h-6 rounded-full flex items-center justify-center border border-cultured mx-auto mb-1 ${ItemIcon === CircleNotchIcon ? "bg-gray-100 " : ""} ${ItemIcon === XIcon ? "bg-red-100" : ""} `}>
