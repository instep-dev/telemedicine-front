...
import {
  ...
  useRequestEmailChangeDoctorMutation,
  useConfirmEmailChangeDoctorMutation,
  useRequestPasswordResetDoctorMutation,
  useVerifyResetCodeDoctorMutation,
  useSetNewPasswordDoctorMutation,
  useUploadProfilePictureDoctorMutation,
...
export default function DoctorProfilePage() {
  ...
  const requestEmailChange = useRequestEmailChangeDoctorMutation();
  const confirmEmailChange = useConfirmEmailChangeDoctorMutation();
  const requestPasswordReset = useRequestPasswordResetDoctorMutation();
  const verifyResetCode = useVerifyResetCodeDoctorMutation();
  const setNewPassword = useSetNewPasswordDoctorMutation();
  const uploadPicture = useUploadProfilePictureDoctorMutation();
