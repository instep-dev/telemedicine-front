...
import { useDoctorSessionsQuery } from "@/services/consultations/consultations.queries";
...
export default function DoctorSchedulePage() {
  ...
  const sessionsQuery = useDoctorSessionsQuery(accessToken, { sort: "oldest" }, true);
  ...
  const canJoin = detail?.doctorJoinState === "JOIN";
  const isJoined = detail?.doctorJoinState === "JOINED";
  ...
  return (
    <>
      <WeeklyCalendar
        ...
        renderSessionTitle={(s) => s.patientName ?? "Patient"}
      />
