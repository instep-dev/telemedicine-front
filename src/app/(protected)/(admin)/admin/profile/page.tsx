...
import {
  ...
  useRequestEmailChangeAdminMutation,
  useConfirmEmailChangeAdminMutation,
  useRequestPasswordResetAdminMutation,
  useVerifyResetCodeAdminMutation,
  useSetNewPasswordAdminMutation,
  useUploadProfilePictureAdminMutation,
...
export default function AdminProfilePage() {
  ...
  const confirmEmailChange = useConfirmEmailChangeAdminMutation();
  const requestPasswordReset = useRequestPasswordResetAdminMutation();
  const verifyResetCode = useVerifyResetCodeAdminMutation();
  const setNewPassword = useSetNewPasswordAdminMutation();
  const uploadPicture = useUploadProfilePictureAdminMutation();
